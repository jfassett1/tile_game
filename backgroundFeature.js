...
function changeBackground() {
  ...
  // Set the puzzle's background image to the selected background.
  puzzle.style.backgroundImage = selectedBackground;
...
puzzle.style.backgroundImage = backgrounds[randomBackgroundIndex];
